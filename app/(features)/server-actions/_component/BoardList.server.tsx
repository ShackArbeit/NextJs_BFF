import { softDeletePost, type BoardKey, type PostDTO } from "../action";
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <DeleteButton
                  action={async () => {
                    "use server";
                    await softDeletePost(board, post._id);
                  }}
                />
              </div>
